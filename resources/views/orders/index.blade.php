...
@section('content')
  <div class="container p-3 m-3 mb-5 w-100 border border-dark bg-gradient bg-secondary text-dark">
    <div class="d-grid gap-2 col-6 mx-auto my-3">
      <h3 class="text-center col">Gerenciamento de Pedidos</h3>
      <a class="btn btn-dark text-light col" href="{{ route('pedidos.create') }}">
        ...
        <tbody class="table-group-divider" id="tablecardapios">
          @foreach ($orders as $order)
            <tr>
              ...
              <td>
                <form class="" action="{{ route('pedidos.destroy', $order->id)}}" method="post">
                  @csrf
                  @method('delete')
